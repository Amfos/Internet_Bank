...
class Test_calc(unittest.TestCase):
    ...
    def test_status_balance(self):
        pin_code = self.terminal.enter_pin_code(333)
        self.assertTrue(self.terminal.user_can_observe_his_balance())
        self.assertEqual(self.terminal.balance, 5000)

    def test_status_cannot_balance(self):
        enter_pin_code = self.terminal.enter_pin_code(222)
